        ...
        <div className="container" style={{ position: 'relative', zIndex: 10 }}>
          ...
          >
            ...
            <p style={{ fontSize: 'clamp(0.95rem, 2.5vw, 1.2rem)', opacity: 0.9, lineHeight: 1.6, marginBottom: '2.5rem' }}>
              Enter your complete AWB Number, LR Number, or Invoice Number to get real-time status updates.
            </p>
            ...
            <form onSubmit={handleTrack} style={{ 
              ...
              <input 
                type="text" 
                placeholder="Enter AWB / LR / Invoice No." 
          ...
          <AnimatePresence mode="wait">
            ...
            {!hasSearched && !isSearching && (
              ...
              >
                ...
                <p style={{ opacity: 0.7, fontSize: '0.95rem' }}>You must enter the full AWB / LR / Invoice number to search.</p>
              </motion.div>
            )}
