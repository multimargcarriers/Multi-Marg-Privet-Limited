  ...
  return (
    <div ref={containerRef} style={{ background: "#e2e8f0", minHeight: "100vh", padding: scale < 1 ? "0.5rem 0.25rem" : "1.5rem 0.75rem", boxSizing: "border-box", width: "100%", overflowX: "hidden" }} className="print-wrapper">
      <style>{`
        ...
        .manifest-table th, .manifest-table td { border: 1.5px solid #64748b; padding: 4px 6px; color: #0f172a; word-wrap: break-word; }
      ...
      <div className="print-main-wrapper" style={{ display: "flex", justifyContent: "center", overflow: "hidden", width: "100%", paddingBottom: "2rem" }}>
        <div className="print-scale-wrapper" style={{ width: `${1122 * scale}px`, height: `${794 * scale}px`, position: "relative" }}>
          <div id="trip-list-content" className="print-container print-container-triplist" style={{ 
            ...
            <div className="premium-border" style={{ height: "auto", minHeight: "0", position: "relative", display: "flex", flexDirection: "column" }}>
              ...
              <div style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, zIndex: 2, pointerEvents: "none", display: "flex", justifyContent: "center", alignItems: "center" }}>
                 <img src="/mc.png" alt="Watermark" style={{ width: "40%", opacity: 0.1 }} />
              </div>
              ...
              <div style={{ position: "relative", zIndex: 1, flex: 1, display: "flex", flexDirection: "column" }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "10px 1.5rem", borderBottom: "2px solid #1e293b" }}>
                  <div style={{ width: "95px", height: "95px", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center" }}><img src="/mc.png" alt="Multimarg Carriers" style={{ width: "100%", height: "100%", objectFit: "contain" }} /></div>
