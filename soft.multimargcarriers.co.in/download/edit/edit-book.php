...
{
$sql="UPDATE trip SET date='$date',mode='$mode',client='$client',origin='$origin',destination='$destination',box='$box',actual_wt='$aweight',charge_wt='$cweight',type_of_delivery='$tob',description='$description',insured='$insured',remarks='$remarks',clerk_name='$clerk',consignor='$consignor',consignee='$consignee' WHERE awb='$consignment'";
