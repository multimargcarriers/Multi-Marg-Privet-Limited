...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="c.jpg">
    <title>Sky 4 Logistics</title>
    <!-- Custom CSS -->
            ...
            <nav class="navbar top-navbar navbar-expand-md">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand" >
                        ...
                        <a href="#">
                           <b class="logo-icon">
                                <!-- Dark Logo icon -->
                                <img src="b1.jpg" alt="homepage" class="dark-logo" />
                                <!-- Light Logo icon -->
                                <img src="b1.jpg" alt="homepage" class="light-logo" />
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
                            <span class="logo-text">
                                <!-- dark Logo text -->
                                <img src="v1.jpg" alt="homepage" class="dark-logo" />
                                <!-- Light Logo text -->
                                <img src="v1.jpg" class="light-logo" alt="homepage" />
                            </span>
                            <!--End Logo icon -->
                            <!-- Logo text -->
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav float-left mr-auto ml-5 pl-1">
                        <!-- Notification -->
                      <p ><h2><b style="color:#020375" style="font-family: Georgia, serif;"><center>SKY 4 LOGISTICS</center></b></h2></p>
                        <!-- End Notification -->
                        <!-- ============================================================== -->
                        <!-- create new -->
                        <!-- ============================================================== -->
