                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="#" style="display:flex; justify-content:center; align-items:center; width:100%;">
                            ...
                            <span class="logo-text">
                                <!-- dark Logo text -->
                                <img src="logo.jpg" alt="homepage"  style="
            height:88px;      /* resize here */
            width:auto;
            max-width:160px;
        "/>
                                <!-- Light Logo text -->
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                <img src="mc.png" alt="user" class="rounded-circle"
                                    width="40">
        ...
        <aside class="left-sidebar" data-sidebarbg="skin6">
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                    <?php if($t=="Operation Team" || $t=="SANJIT" ){ ?>
                      <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="dashboard.php"
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                ...
                                <li class="sidebar-item"><a href="tripsheet.php" class="sidebar-link"><span
                                            class="hide-menu"><B style="color:black"> Trip Sheet</B>
                                        </span></a>
                                </li>
                        ...
                        <li class="sidebar-item"><a href="trip-bill.php" class="sidebar-link"><i data-feather="grid" class="feather-icon"></i><span
                                    class="hide-menu"><B style="color:black">Trip Bills</B> </span></a>
                        </li>
                        ...
                        <li class="sidebar-item"> <a href="clienttrip_reports.php" class="sidebar-link"><i class="fa fa-credit-card"></i><span
                                    class="hide-menu"><B style="color:black">Client Trip Reports </B></span></a>
                        </li>
                        <?php } ?>
                        <li class="list-divider"></li>
