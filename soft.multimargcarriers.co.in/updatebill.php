        ...
        <div class="tm_invoice_in">
          <div class="tm_invoice_head tm_top_head tm_mb20">
            <div class="tm_invoice_left">
              <div class="tm_logo">  <img src="mc.png" style="max-width:300px; height: 100px;"></div>
            </div>
            <div class="tm_invoice_right">
              <div class="tm_grid_row tm_col_6">
                <div>
                  <center>
                   <div style="font-size:30px; font-weight:bold; color:#003366;font-family: Georgia, serif; ">
  ...
  <tbody>
    ...
    while($row=mysqli_fetch_array($retval)) {
        ...
        <tr>
          ...
          <td>$origin</td>
          <td>$dest</td>
          <td><input type='text' name='box[]' value='$pkg' style='width:80px;'></td>
