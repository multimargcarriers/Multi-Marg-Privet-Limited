...
{
$sql="INSERT INTO rates (pid,code,client,origin,destination,awb,air_rate,air_pickup,air_delivery,train_rate,train_pickup,train_delivery,road_rate,road_pickup,road_delivery,roadexpress_rate,roadexpress_pickup,roadexpress_delivery) VALUES('0','$code','$client','$origin','$destination','$awb','$ar','$ap','$ad','$tr','$tp','$td','$rr','$rp','$rd','$re','$rep','$red')";
#execute above sql
