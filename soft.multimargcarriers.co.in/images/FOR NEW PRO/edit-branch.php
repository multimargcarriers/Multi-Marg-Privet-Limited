...
$v=$_GET['code'];
$query="select * from branch where pid=$v";
...
?>
    ...
    <div class="row">
            ...
            <!-- Input -->
            <form class="login100-form validate-form" method="POST" id="frm1" action="edit/edit-branch.php">
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    
                    
                        <div class="body">
                            <h2 class="card-inside-title">Update Branch</h2>
                            <div class="row clearfix">
                           
                                
                                <div class="col-sm-6" data-validate = "Branch is required">
                                    <div class="form-group">                                   
                                    <label><b>Branch Code</b></label> <input type="text" class="form-control" name="code" value=<?php echo $code;?> disabled />                                    
                                    </div>
                                </div>
                                
                                <div class="col-sm-6" data-validate = "Phno is required">
                                    <div class="form-group">                                    
                                    <label><b>Branch Name<span style="color:red">*<span></b></label>  <input type="text" class="form-control" name="branch" value="<?php echo $branch;?>"  required/>                                   
                                    </div>
                                </div>
