...
<td><input type='text' class='form-control' name='weight[$awb]' value=".$row['charge_wt']."></td>";
...
if($m=='AIR' && $origin==$o1 && $destination==$d1 ){
    ...
    echo"<td><input type='text' class='form-control' name='arate[$awb]' value=".$row1['air_rate']."></td>
    <td><input type='text' class='form-control' name='frieght[$awb]' value=".($c*$row1['air_rate'])."></td>
    ...
    elseif($m=='TRAIN' && $o==$o1 && $d==$d1 ){
        echo"<td><input type='text' class='form-control' name='arate[$awb]' value=".$row1['train_rate']."></td>
        <td><input type='text' class='form-control' name='frieght[$awb]' value=".($c*$row1['train_rate'])."></td>
        <td><input type='text' class='form-control' name='lrc[$awb]' value=".$row1['awb']."></td>
        ...
        elseif($m=='ROAD' && $o==$o1 && $d==$d1 ){
            echo"<td><input type='text' class='form-control' name='arate[$awb]' value=".$row1['road_rate']."></td>
            <td><input type='text' class='form-control' name='frieght[$awb]' value=".($c*$row1['road_rate'])."></td>
            <td><input type='text' class='form-control' name='lrc[$awb]' value=".$row1['awb']."></td>
...
echo "</tbody></table>";
echo "<center><button class='btn btn-raised btn-primary waves-effect' onclick=".'myok()'." value='GENERATE'>GENERATE & PRINT</button</center></form> ";
}
