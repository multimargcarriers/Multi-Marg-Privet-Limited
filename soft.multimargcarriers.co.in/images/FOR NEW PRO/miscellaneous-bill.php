                        ...
                        <div class="body">
                            ...
                            <div class="col-sm-4" data-validate = "Employee Name is required">
                                    ...
                                    <label><b style="color: #A44C13;">Invoice Prefix<span style="color:red">*<span></b></label> <select class="form-control show-tick" name="prefix">
                                        <option value="S4L/25-26/">S4L/25-26/</option>
                                        <option value="S4L/26-27/">S4L/26-27/</option>
                                        <option value="S4L/27-28/">S4L/27-28/</option>
                                        <option value="S4L/28-29/">S4L/28-29/</option>
                                        <option value="S4L/29-30/">S4L/29-30/</option>
                                        </select>  
                                    </div>
