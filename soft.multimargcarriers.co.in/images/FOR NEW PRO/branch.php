...
$query="select * from branch order by code desc limit 1";
                            $result=mysqli_query($con,$query);
                            $row=mysqli_fetch_array($result);
                            $last=$row['code'];
                            $lastst= substr($last, -2);
                            if($lastst=="")
                            {
                                $a="001";
                            }
...
?>
    ...
    <div class="row">
            ...
            <!-- Input -->
            <form class="login100-form validate-form" method="POST" id="frm1" action="add/add-branch.php">
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    
                    
                        <div class="body">
                            <h2 class="card-inside-title">Add Branch</h2>
                            <div class="row clearfix">
                            <div class="col-sm-6" data-validate = "Employee Name is required">
                                ...
                                <div class="col-sm-6" data-validate = "Branch is required">
                                    <div class="form-group">                                   
                                    <label><b>Branch Code</b></label> <input type="text" class="form-control" name="code" value=<?php echo $a;?> required />                                    
                                    </div>
                                </div>
                                
                                <div class="col-sm-6" data-validate = "Phno is required">
                                    <div class="form-group">                                    
                                    <label><b>Branch Name<span style="color:red">*<span></b></label>  <input type="text" class="form-control" name="branch" placeholder="Enter Branch"  required/>                                   
                                    </div>
                                </div>
                            ...
                            <center><div class="col-sm-6">
                                    <div class="form-group">                                   
                                    <input type="button" class="btn btn-raised btn-primary waves-effect" onclick="submitForm()" value="ADD BRANCH" />                                 
                                    </div>
                                </div></center>
</div>
...
<?php include('tables/branch_table.php'); ?>
</div>
